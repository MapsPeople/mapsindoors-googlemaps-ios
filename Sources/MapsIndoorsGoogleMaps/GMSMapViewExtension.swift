...
@objc public extension GMSMapView {
    ...
    func getMapsIndoorsGoogleMapsIndexRange(for mpLayer: MPLayer) -> NSRange {
        extractedFunc(mpLayer)
    }

    private func extractedFunc(_ mpLayer: MPLayer) -> NSRange {
...
private extension MapOverlayZIndex {
